...
| <a name="module_secrets"></a> [secrets](#module\_secrets) | git@github.com:companieshouse/terraform-modules//aws/ecs/secrets | 1.0.338 |
...
| <a name="input_human_log"></a> [human\_log](#input\_human\_log) | n/a | `string` | `"1"` | no |
...
| <a name="input_presenter_account_api_version"></a> [presenter\_account\_api\_version](#input\_presenter\_account\_api\_version) | The version of the presenter account api container to run. | `string` | n/a | yes |
