...
class PresenterAccountAddressTest {
    ...
    void testInvalidPresenterAddressWithoutPremises() {
        Exception e = assertThrows(ValidationException.class, () -> {new PresenterAccountAddress("", FIRST_LINE, SECOND_LINE, COUNTY, COUNTRY, POSTCODE);});
    ...
    void testInvalidPresenterAddressWithoutFirstLine() {
        Exception e = assertThrows(ValidationException.class, () -> {new PresenterAccountAddress(PREMISES, "", SECOND_LINE, COUNTY, COUNTRY, POSTCODE);});
    ...
    void testInvalidPresenterAddressWithoutCountry() {
        Exception e = assertThrows(ValidationException.class, () -> {new PresenterAccountAddress(PREMISES, FIRST_LINE, SECOND_LINE, COUNTY, "", POSTCODE);});
    ...
    void testInvalidPresenterAddressWithoutPostcode() {
        Exception e = assertThrows(ValidationException.class, () -> {new PresenterAccountAddress(PREMISES, FIRST_LINE, SECOND_LINE, COUNTY, COUNTRY, "");});
    ...
    void testInvalidPresenterAddressWithTooLongPremises() {
        Exception e = assertThrows(ValidationException.class, () -> {new PresenterAccountAddress(STRING_TOO_LONG, FIRST_LINE, SECOND_LINE, COUNTY, COUNTRY, POSTCODE);});
        assertTrue(e.getMessage().contains("premises"));
    }
    ...
    void testInvalidPresenterAddressWithTooLongFirstLine() {
        Exception e = assertThrows(ValidationException.class, () -> {new PresenterAccountAddress(PREMISES, STRING_TOO_LONG, SECOND_LINE, COUNTY, COUNTRY, POSTCODE);});
        assertTrue(e.getMessage().contains("address line 1"));
    }
    ...
    void testInvalidPresenterAddressWithTooLongSecondLine() {
        Exception e = assertThrows(ValidationException.class, () -> {new PresenterAccountAddress(PREMISES, FIRST_LINE, STRING_TOO_LONG, COUNTY, COUNTRY, POSTCODE);});
    ...
    void testInvalidPresenterAddressWithTooLongCountry() {
        Exception e = assertThrows(ValidationException.class, () -> {new PresenterAccountAddress(PREMISES, FIRST_LINE, SECOND_LINE, COUNTY, STRING_TOO_LONG, POSTCODE);});
        assertTrue(e.getMessage().contains("country"));
    }
    ...
    void testInvalidPresenterAddressWithTooLongPostcode() {
        Exception e = assertThrows(ValidationException.class, () -> {new PresenterAccountAddress(PREMISES, FIRST_LINE, SECOND_LINE, COUNTY, COUNTRY, STRING_TOO_LONG);});
        assertTrue(e.getMessage().contains("postcode"));
    }
    ...
    void testInvalidPresenterAddressWithInvalidCharacter() {
        Exception e = assertThrows(ValidationException.class, () -> {new PresenterAccountAddress(PREMISES, INVALID_STRING, SECOND_LINE, COUNTY, COUNTRY, POSTCODE);});
        assertTrue(e.getMessage().contains("address line 1"));
    }
}
