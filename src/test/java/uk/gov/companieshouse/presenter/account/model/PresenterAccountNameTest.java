...
class PresenterAccountNameTest {
    ...
    void testInvalidPresenterNameWithoutFirstOrSurname() {
        Exception firstNameException = assertThrows(ValidationException.class, () -> {new PresenterAccountName("", LAST_NAME);});
        Exception surnameException = assertThrows(ValidationException.class, () -> {new PresenterAccountName(FIRST_NAME, "");});
    ...
    void testInvalidPresenterNameWithTooLongFirstOrSurname() {
        Exception firstNameException = assertThrows(ValidationException.class, () -> {new PresenterAccountName(TOO_LONG_NAME, LAST_NAME);});
        Exception surnameException = assertThrows(ValidationException.class, () -> {new PresenterAccountName(FIRST_NAME, TOO_LONG_NAME);});
        assertTrue(firstNameException.getMessage().contains("Name"));
        assertTrue(surnameException.getMessage().contains("Name"));
    }
    ...
    void testInvalidPresenterNameWithInvalidCharacterFirstOrSurname() {
        Exception firstNameException = assertThrows(ValidationException.class, () -> {new PresenterAccountName(INVALID_CHARACTOR_NAME, LAST_NAME);});
        Exception surnameException = assertThrows(ValidationException.class, () -> {new PresenterAccountName(FIRST_NAME, INVALID_CHARACTOR_NAME);});
        assertTrue(firstNameException.getMessage().contains("Name"));
        assertTrue(surnameException.getMessage().contains("Name"));
    }
}
