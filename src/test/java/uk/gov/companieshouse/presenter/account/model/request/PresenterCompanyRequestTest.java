...
class PresenterCompanyRequestTest {
    ...
    void testWhetherCompanyNumberCanBeNull() {
        PresenterCompanyRequest presenterCompanyRequest = new PresenterCompanyRequest(COMPANY_NAME,
                null);
        assertEquals(COMPANY_NAME, presenterCompanyRequest.companyName());
        assertNull(presenterCompanyRequest.companyNumber());
        assertEquals(
                "PresenterCompanyRequest[companyName=%s, companyNumber=%s]".formatted(COMPANY_NAME,
                        "null"), presenterCompanyRequest.toString());
    }
    ...
    void testBothCompanyNameAndNumberSet() {
        ...
        assertEquals(
                "PresenterCompanyRequest[companyName=%s, companyNumber=%s]".formatted(COMPANY_NAME,
                        COMPANY_NUMBER), presenterCompanyRequest.toString());
    }
